                            ...
                            <article class="cart-area pay">
                                ...
                                <div class="step-wrap">
                                    <div class="cart-waiting-tab">
                                            <ul>
                                                                <li><a href="cart_list_form.jsp">배달<span class="itemA">30분 소요</span></a></li>
                                                                <li class="active"><a href="">포장<span class="itemB">15분 소요</span></a></li>
                                                            </ul>
                                                        </div>
                                ...
                                <!-- //주소 -->
                                <!-- 주문 내역 -->
                                <form name = "cart_view_form" action="cart_takeout_delete_action.jsp" method = "POST"></form>
                                <div class="step-wrap">
                                        <div class="title-wrap">
                                            ...
                                            <span class="summary side"> 
                                                <a href="javascript:cart_delete();">전체 삭제</a>
                                            </span>
                                        </div>
                                        <div class="cart-list">
                                            <ul>
									...
									<li class="row" id="sold-out0">
											...
											<div class="prd-option">
											 ...
											 <div class="prd-quantity">
                           						 ...
                           						 <a href="javascript:changeNumber('-', '<%=cart.getCart_no()%>');"  class="minus"><button class="btn-minus"></button></a>
                                                 <input type="number" class="qty0" id="qty<%=cart.getCart_no()%>" value="<%=cart.getCart_qty() %>" readonly="readonly">
                                                 <a href="javascript:changeNumber('+', '<%=cart.getCart_no()%>');"  class="plus"><button class="btn-plus"></button></a>
                                                 </div>
