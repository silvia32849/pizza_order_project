...
<script type="text/javascript">
	...
	deliveryButton.addEventListener("click", function() {
	    // 배달 버튼 활성화
	    deliveryButton.parentElement.classList.add("active");
	    // 포장 버튼 비활성화
	    takeoutButton.parentElement.classList.remove("active");
	});

	// 포장 버튼을 클릭할 때
	takeoutButton.addEventListener("click", function() {
	    // 포장 버튼 활성화
	    takeoutButton.parentElement.classList.add("active");
	    // 배달 버튼 비활성화
	    deliveryButton.parentElement.classList.remove("active");
	});
</script>
<body>
	<div class="warp">
						...
						<article class="cart-area pay">
							...
							<div class="step-wrap">
								<div class="cart-waiting-tab">
									<ul>
										<li><a id="deliveryButton" href="cart_list_form.jsp?order_delivery=0">배달<span class="itemA">30분
													소요</span></a></li>
										<li><a id="takeoutButton" href="cart_list_form.jsp?order_delivery=1">포장<span
