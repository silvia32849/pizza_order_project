                    ...
                    <div class="sub-type cart">
                        <div class="inner-box">
                            ...
                            <article class="cart-area pay">
                                ...
                                <div class="step-wrap">
                                    <div class="cart-waiting-tab">
                                            <ul>
                                                                ...
                                                                <li><a href="cart_takeout_list_form.jsp">포장<span class="itemB">15분 소요</span></a></li>
                                                            </ul>
                                                        </div>
                                ...
                                <!-- //주소 -->
                                <!-- 주문 내역 -->
                                <form name = "cart_view_form" action="cart_delete_action.jsp" method = "POST"></form>
                                ...
                                <div class="step-wrap">
									...
									<li class="row" id="sold-out0">
											...
											<div class="prd-delete">
												...
												<a
													href="javascript:cart_deleteItem('<%=cart.getCart_no()%>')"
