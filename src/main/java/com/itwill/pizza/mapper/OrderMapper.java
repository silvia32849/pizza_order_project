...
public interface OrderMapper {
	    ...
	    //1. insert
		   //주문 추가   
		   @Insert("insert into orders (order_no, order_name, order_address, order_price, order_date, order_delivery, user_id) "
		         + "      values(orders_order_no_SEQ.nextval, #{order_name}, #{order_address}, #{order_price}, #{order_date}, #{order_delivery}, #{user_id})")
